        ...
        <div class="mx-auto max-w-7xl px-3">  
          <div class="mt-1 flex items-center">
            <div class="space-y-6 md:w-3/4 ">
              ...
              <p class="text-3xl font-bold text-blue-500 md:text-4xl underline">
                Meet our team
              </p>
              <p class="max-w-4xl text-base text-gray-200 md:text-xl">
          ...
          <div class=" grid grid-cols-1 gap-4 gap-y-6 border-b  border-gray-300 py-12 pb-20 md:grid-cols-2 lg:grid-cols-4 ">
            ...
            <a href="https://www.linkedin.com/in/aslaan-khan-1824a1272/">
              ...
              <p class="mt-6 w-full px-2 text-xl text-center font-semibold text-blue-500">
               Aslaan Khan
              </p>
              <p class="w-full px-2 pb-6 text-sm font-semibold text-center text-gray-200">
                Backend Apis 
              </p>
              ...
              <a href="https://www.linkedin.com/in/aslaan-khan-1824a1272/">
              <button className=' ml-28 mb-4 bg-blue-400 rounded-xl w-16 h-8 '> Profile</button>
              </a>
            ...
            <div class="rounded-md border">
              <img
                ...
                class="h-[350px] w-full rounded-lg object-cover "
              />
              <p class="mt-6 w-full px-2 text-xl  font-semibold text-blue-500">
                Mohd. Owaish Khan
              </p>
              <p class="w-full px-2 pb-6 text-sm font-semibold text-gray-200">
                FrontEnd 
              </p>
